...
graph TD
    ...
    classDef coklat fill:#f8d7da,stroke:#dc3545,stroke-width:2px,color:#333;

    A[Sisa Dapur & Limbah Organik] --> B(Biopond Maggot BSF):::coklat
    B -->|Maggot| C(Ayam Petelur):::kuning
    B -->|Kasgot| D(Komposter):::coklat
    C -->|Kotoran| D
    C -->|Telur| E[Sumber Protein Keluarga]:::hijau
    D -->|Kompos Matang| F(Raised Bed Sayuran):::hijau
    G(Bioflok Lele):::biru -->|Air Nutrisi| F
    F -->|Panen Sayur| E
    G -->|Panen Lele| E
```
...
```mermaid
pie title "Proyeksi Proporsi Pendapatan Tahunan"
    "Kosmetik In-Game (Robux)" : 40
    "Paket Ekspansi" : 25
    "Kemitraan NGO" : 15
    "Lisensi Sekolah" : 10
    "Token Kenyamanan" : 10
...
```mermaid
gantt
    title Roadmap Eksekusi SMBPC 2026-2027
    dateFormat  YYYY-MM
    axisFormat  %b '%y
    
    section Fase 1: Buktikan
    GDD Selesai & Validasi  :done,    des1, 2026-07, 2026-08
    Dev Simulator Lele      :active,  des2, 2026-08, 2026-11
    Uji Coba 5 Sekolah      :         des3, 2026-11, 2026-12
    Iterasi & Feedback      :         des4, 2026-12, 2027-01
    
    section Fase 2: Luncurkan
    Soft Launch 5k User     :         des5, 2027-01, 2027-04
    Monetisasi Aktif        :         des6, 2027-04, 2027-07
    
    section Fase 3: Skala
